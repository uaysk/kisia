...
배경: 중소기업의 경우, 대기업이나 빅테크 기업처럼 다양한 보안 솔루션을 도입하거나 SSO(Single Sign-On) 기반의 통합 인증 체계를 구축하기 어렵다. 이러한 환경적 제약으로 인해 사용자 행위 데이터를 수집·분석하여 신뢰도 점수를 산정하는 제로 트러스트 모델을 구현하는 데 현실적인 한계가 존재한다.
